...
- **Pass 2 (belum):** `frac_add` (½ + 1,4 → ember **add**) & `frac_dec` (½ = 0,5 → ember **frac**) — jawaban desimal, penyebut dibatasi {2,5,10} biar hasil 1 koma. **Butuh input pecahan** (tombol `/`) hanya kalau mau `2/4 → ½` & `½+¼=¾` — itu pass terpisah.
